...
def in6_or(a1, a2):
    ...
    passed in scapy_ format. Return value is also an IPv6 address
    in scapy_ format.
    """
...
def in6_getnsma(a):
    ...
    address. Passed address must be provided in scapy_ format.
    Returned value is also in scapy_ format.
    """
...
def in6_getnsmac(a):  # return multicast Ethernet address associated with multicast v6 destination  # noqa: E501
    ...
    IPv6 address. Passed address must be in scapy_ format.
    """
...
class Net6(Gen):  # syntax ex. fec0::/126
    """Generate a list of IPv6s from a scapy_ address or a name"""
    name = "ipv6"
