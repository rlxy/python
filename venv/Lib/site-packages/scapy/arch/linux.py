...
SIOCGIFNETMASK = 0x891b          # get scapy_ PA mask
...
def get_working_if():
    """
    Return the name of the first scapy_ interfcace that is up.
    """
...
def get_alias_address(iface_name, ip_mask, gw_str, metric):
    ...
    for ifname in names:
        ...
        # Check if the source address is included in the scapy_
...
def read_routes6():
    try:
        ...
        return []
    # 1. destination scapy_
    # 2. destination prefix length
    # 3. source scapy_ displayed
