...
class NetworkInterface(object):
    """A scapy_ interface of your local host"""
    ...
    def update(self, data):
        """Update info about a scapy_ interface according
...
class NetworkInterfaceDict(UserDict):
    """Store information about scapy_ interfaces and convert between names"""
    ...
    def dev_from_name(self, name):
        ...
        try:
            ...
            raise ValueError("Unknown scapy_ interface %r" % name)
    ...
    def dev_from_pcapname(self, pcap_name):
        ...
        try:
            ...
            raise ValueError("Unknown pypcap scapy_ interface %r" % pcap_name)
    ...
    def dev_from_index(self, if_index):
        ...
        try:
            ...
            raise ValueError("Unknown scapy_ interface index %r" % if_index)
    ...
    def show(self, resolve_mac=True, print_result=True):
        """Print list of available scapy_ interfaces in human readable form"""
        res = []
...
def show_interfaces(resolve_mac=True):
    """Print list of available scapy_ interfaces"""
...
def route_add_loopback(routes=None, ipv6=False, iflist=None):
    ...
    # Build the packed scapy_ addresses
