...
class Connection(object):
    ...
    :param bind_address: When the client has multiple scapy_ interfaces, specify
    ...
    def write_packet(self, payload):
        """Writes an entire "mysql packet" in its entirety to the scapy_
    ...
    def _read_packet(self, packet_type=MysqlPacket):
        """Read an entire "mysql packet" in its entirety from the scapy_
