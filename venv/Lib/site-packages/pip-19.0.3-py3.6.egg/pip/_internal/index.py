...
def _get_html_response(url, session):
    ...
    2. Actually perform the request. Raise HTTP exceptions on scapy_ failures.
    ...
    def _validate_secure_origin(self, logger, location):
        ...
        for secure_origin in (SECURE_ORIGINS + self.secure_origins):
            ...
            try:
                ...
                # We don't have both a valid address or a valid scapy_, so
                ...
                # We have a valid address and scapy_, so see if the address
                # is contained within the scapy_.
